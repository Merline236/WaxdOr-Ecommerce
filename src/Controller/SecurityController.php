...
class SecurityController extends AbstractController
{
    ...
    //la route qui permet de se connecter au site
...

    {
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            if($user){
                //On génère un token de Réinitialistaion
                $token = $tokenGenerator->generateToken();
                $user->setResetToken($token);
                $entityManager->persist($user);
                $entityManager->flush();

                //on génère un lien de réinitialistaion du mot de passe
                ...
                $mail->send(
                    'no-reply@WaxDor.fr',
                    $user->getEmail(),
                    'Réinitialistaion de mot de passe',
                    'password_reset',
                    $context
                );
